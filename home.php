  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="#"></a>Admin</li>
      ...
      <form class="d-flex" role="logout">
        <a href="logout.php" class="btn btn-outline-success" type="submit" name="logout">Logout</a>
      </form>
    </div>
  </div>
</nav>
...
<div class="mt-4 p-5 bg-primary text-white rounded bg-secondary text-center">
  ...
  <a type="button" class="btn btn-primary" href="peminjaman2.php">Show Here</a>
